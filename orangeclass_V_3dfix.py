...
#FUDGES TO MAKE WORK ON DESKTOP-1 of 2----------------------------------------
        self.framepic.pack(anchor=tk.CENTER,pady=150)
        # self.framepic.pack(side=tk.TOP)
        # self.framepic.pack(side=tk.TOP,fill=tk.BOTH,expand=1)
#FUDGES TO MAKE WORK ON DESKTOP- 1 of 2----------------------------------------
  ...
  #------------------BOX FIX-----------------------------------------     
        ...
        TextBox.list_box=[] # clear all Textbox reference.
...
#         framehide.pack(side=tk.TOP,anchor='w',pady=5)
        ...
        # self.outsideframepic.pack_propagate(False)   
        self.canvas=tk.Canvas(self.framepic,width=200, height=100)   
        # self.canvas=tk.Canvas(self.framepic,width=800, height=800)
...
#FUDGES TO MAKE WORK ON DESKTOP-2 of 2----------------------------------------
        ...
        # self.canvas._tkcanvas.pack(fill=tk.BOTH, expand=1) #FOR DESKTOP!!!
#HERE NOT NEEDED!!
#FUDGES TO MAKE WORK ON DESKTOP-2 of 2---------------------------------------- 
